...
var reactCore = require('@tinacms/react-core');
...
var fields = require('@tinacms/fields');
var reactDismissible = require('react-dismissible');
var reactModals = require('@tinacms/react-modals');
var finalForm = require('final-form');
var nextTinacmsMarkdown = require('next-tinacms-markdown');
...
var AsyncButton = function AsyncButton(_ref) {
  ...
  return React__default.createElement(styles.Button, {
    primary: primary,
    onClick: onClick,
    busy: submitting,
    disabled: submitting
  }, submitting && React__default.createElement(reactForms.LoadingDots, null), !submitting && name);
};
...
function ModalBuilder(modalProps) {
  return React__default.createElement(styles.StyleReset, null, React__default.createElement(tinacms.Modal, null, React__default.createElement(tinacms.ModalPopup, null, React__default.createElement(tinacms.ModalHeader, {
    close: modalProps.close
  }, modalProps.title), React__default.createElement(tinacms.ModalBody, {
    padded: true
  }, React__default.createElement("p", null, modalProps.message), modalProps.error && React__default.createElement(ErrorLabel, null, modalProps.error)), React__default.createElement(tinacms.ModalActions, null, modalProps.actions.map(function (action) {
...
var ActionableModal = function ActionableModal(_ref) {
  ...
  return React__default.createElement(styles.StyleReset, null, React__default.createElement(tinacms.Modal, null, React__default.createElement(tinacms.ModalPopup, null, React__default.createElement(tinacms.ModalHeader, null, title), React__default.createElement(tinacms.ModalBody, {
    padded: true
  }, React__default.createElement("p", null, message)), React__default.createElement(tinacms.ModalActions, null, actions.map(function (action) {
    return React__default.createElement(styles.Button, {
...
var GithubErrorModal = function GithubErrorModal(props) {
  ...
  var github = tinacms.useCMS().api.github;
  var cms = tinacms.useCMS();
  React.useEffect(function () {
...
var TinacmsGithubProvider = function TinacmsGithubProvider(_ref) {
  ...
  var _useState = React.useState(previewError),
      error = _useState[0],
      setError = _useState[1];
...
var PRModal = function PRModal() {
  ...
  }, "View changes on GitHub"), "."), React__default.createElement(tinacms.FieldMeta, {
    label: "PR Title",
    name: "title"
  }, React__default.createElement(fields.Input, {
    type: "text",
    ref: titleInput
  })), React__default.createElement(tinacms.FieldMeta, {
    label: "PR Description",
    name: "description"
  }, React__default.createElement(fields.TextArea, {
    ref: bodyInput
  }))), fetchedPR.id && React__default.createElement(ModalDescription, null, "You've created a pull request from ", React__default.createElement("b", null, workingBranch), " into", ' ', React__default.createElement("b", null, baseBranch), ".")), React__default.createElement(tinacms.ModalActions, null, !fetchedPR.id && React__default.createElement(AsyncButton, {
    primary: true,
...
var PrModalBody =
/*#__PURE__*/
styled__default(tinacms.ModalBody)(
/*#__PURE__*/
_templateObject3());
...
function PullRequestButton() {
  ...
  }, React__default.createElement(icons.PullRequestIcon, null), React__default.createElement(DesktopLabel, null, " Pull Request")), opened && React__default.createElement(tinacms.Modal, null, React__default.createElement(tinacms.ModalPopup, null, React__default.createElement(tinacms.ModalHeader, {
    close: close
  }, "Pull Request"), React__default.createElement(tinacms.ModalBody, null, React__default.createElement(PRModal, null)))));
}
...
var RepoInfo = function RepoInfo() {
  var cms = tinacms.useCMS();
  var github = cms.api.github;
  return React__default.createElement(tinacms.FieldMeta, {
...
var BranchSwitcher = function BranchSwitcher(_ref) {
  ...
  var selectListRef = React.useRef();

  var _React$useState5 = React.useState('pending'),
  ...
  var updateBranchList = React.useCallback(function () {
  ...
  return React.createElement(React.Fragment, null, React.createElement(SelectWrapper, null, React.createElement(SelectBox, {
    onClick: function onClick() {
      return setOpen(!open);
    },
    open: open
  }, React.createElement(SelectLabel, null, "Branch"), React.createElement(SelectCurrent, null, github.branchName), React.createElement(icons.ChevronDownIcon, null)), React.createElement(SelectDropdown, {
    open: open
  ...
  }, React.createElement(DropdownHeader, null, React.createElement(SelectFilter, {
    placeholder: "Filter",
    ...
    ref: selectListRef
  }, branchStatus === 'pending' && React.createElement(SelectLoadingState, null, React.createElement(reactForms.LoadingDots, {
    color: "var(--tina-color-primary)"
  })), branchStatus === 'loaded' && React.createElement(React.Fragment, null, filteredBranches.map(function (option) {
    ...
    }, option["protected"] && React.createElement(icons.LockIcon, null), " ", option.name);
  }), filteredBranches.length === 0 && React.createElement(SelectEmptyState, null, "No branches to display.")), branchStatus === 'error' && React.createElement(SelectEmptyState, null, "We had trouble loading branches. Please refresh to try again.")), React.createElement(DropdownActions, null, React.createElement(CreateButton, {
    onClick: openCreateBranchModal
  }, React.createElement(icons.AddIcon, null), " New Branch"))))), createBranchProps && React.createElement(CreateBranchModal, {
  ...
  }), confirmSwitchProps && React.createElement(ConfirmSwitchBranchModal, {
...
var CreateBranchModal = function CreateBranchModal(_ref2) {
  ...
  return React.createElement(tinacms.Modal, null, React.createElement(tinacms.FormBuilder, {
    form: form
  }, function (_ref4) {
    var handleSubmit = _ref4.handleSubmit;
    return React.createElement(tinacms.ModalPopup, null, React.createElement(tinacms.ModalHeader, {
      close: close
    }, "Create Branch"), React.createElement(tinacms.ModalBody, {
      onKeyPress: function onKeyPress(e) {
        return e.charCode === 13 ? handleSubmit() : null;
      }
    }, React.createElement(tinacms.FieldsBuilder, {
      form: form,
      fields: form.fields
    }), React.createElement(ModalText, null, React.createElement("p", null, "Create branch\xA0", React.createElement(BranchName, null, name), "\xA0from '", current, "'"))), React.createElement(tinacms.ModalActions, null, React.createElement(styles.Button, {
      onClick: close
...
var ConfirmSwitchBranchModal = function ConfirmSwitchBranchModal(_ref5) {
  var name = _ref5.name,
      ...
      close = _ref5.close;
  return React.createElement(tinacms.Modal, null, React.createElement(tinacms.ModalPopup, null, React.createElement(tinacms.ModalHeader, {
    close: close
  }, "Switch Branch"), React.createElement(tinacms.ModalBody, {
    padded: true,
    onKeyPress: function onKeyPress(e) {
      return e.charCode === 13 ? onBranchChange() : null;
    }
  }, React.createElement("p", null, "Are you sure you want to switch to branch", ' ', React.createElement(BranchName, null, name), "?")), React.createElement(tinacms.ModalActions, null, React.createElement(styles.Button, {
    onClick: close
  }, "Cancel"), React.createElement(styles.Button, {
...
_templateObject9(), function (p) {
  return p.active && styled.css(_templateObject10());
});
var SelectList =
/*#__PURE__*/
styled__default.div(
...
_templateObject13(), function (p) {
  return p.open && styled.css(_templateObject14());
});
var SelectBox =
/*#__PURE__*/
styled__default.button(
...
_templateObject15(), function (p) {
  return p.open && styled.css(_templateObject16(), SelectLabel);
});
var SelectLabel =
/*#__PURE__*/
styled__default.span(
...
var useGithubToolbarPlugins = function useGithubToolbarPlugins() {
  tinacms.usePlugins([RepoToolbarWidget, PullRequestToolbarWidget, BranchSwitcherPlugin]);
};
...
var createGithubDeleteAction = function createGithubDeleteAction(_temp) {
  ...
  var DeleteAction = function DeleteAction(_ref2) {
    ...
    return React.createElement(React.Fragment, null, React.createElement(reactForms.ActionButton, {
      onClick: open
    }, "Delete " + title), active && React.createElement(reactModals.Modal, null, React.createElement(reactModals.ModalPopup, null, React.createElement(reactModals.ModalHeader, {
      close: close
    }, "Delete " + title, " "), React.createElement(reactModals.ModalBody, null, "Are you sure you want to delete " + title), React.createElement(reactModals.ModalActions, null, React.createElement(styles.Button, {
      onClick: function () {
        try {
    ...
    }, "Yes"), React.createElement(styles.Button, {
      onClick: close
    }, "No")))));
  };
  ...
  var _useForm = tinacms.useForm({
    ...
    onSubmit: function onSubmit(formData) {
      ...
      return githubFile.commit(formData).then(function () {
        ...
        return _ref = {}, _ref[finalForm.FORM_ERROR] = error, _ref;
      });
    }
  }),
      formData = _useForm[0],
...
function useGithubMarkdownForm(markdownFile, formOptions) {
  return useGithubFileForm(markdownFile, _extends({}, formOptions, {
    serialize: nextTinacmsMarkdown.toMarkdownString
  }));
}
...
exports.CreateForkModal = CreateForkModal;
exports.ErrorLabel = ErrorLabel;
exports.GITHUB_AUTH_CODE_KEY = GITHUB_AUTH_CODE_KEY;
exports.GithubAuthenticationModal = GithubAuthenticationModal;
exports.GithubClient = GithubClient;
exports.GithubFile = GithubFile;
exports.GithubMediaStore = GithubMediaStore;
exports.ModalBuilder = ModalBuilder;
exports.RepoToolbarWidget = RepoToolbarWidget;
exports.TinacmsGithubProvider = TinacmsGithubProvider;
exports.authenticate = authenticate;
exports.createGithubDeleteAction = createGithubDeleteAction;
exports.useGithubAuthRedirect = useGithubAuthRedirect;
exports.useGithubFile = useGithubFile;
exports.useGithubFileForm = useGithubFileForm;
exports.useGithubJsonForm = useGithubJsonForm;
exports.useGithubMarkdownForm = useGithubMarkdownForm;
exports.useGithubToolbarPlugins = useGithubToolbarPlugins;
//# sourceMappingURL=react-tinacms-github.cjs.development.js.map
